...
public class CongestionService {
    ...
    public List<String> placeConInfo(CongestionResponseDto congestionResponseDto) throws IOException {
        ...
        try {
            ...
            for (JsonNode rltmNode : rltmArray) {
                double congestionValue = rltmNode.path("congestion").asDouble();
                placeConList.add(decimalFormat.format(congestionValue));
            }
    ...
    public List<List<String>> StatisticalnInfo(CongestionResponseDto congestionResponseDto) throws IOException {
        ...
        return StatisticalnList;
    }

    
    public List<List<String>> getVisitorCountInfo(CongestionResponseDto congestionResponseDto) throws IOException {
